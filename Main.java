...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        mensagens[0] = new Email("boas-vindas", 2500);
        mensagens[1] = new Email("promocao-agosto", 800);
        mensagens[2] = new SMS("codigo-verificacao", 300);
        ...
        for (Mensagem mensagem : mensagens) {
            ...
            total = total + mensagem.calcularCusto();
        }

        System.out.printf("%nTOTAL DA FATURA: R$ %.2f%n", total);

        if (total > 100.00) {
            System.out.println(
                "Atencao: fatura acima do limite contratado."
            );
        } else {
            System.out.println(
                "Fatura dentro do limite."
            );
        }
    }
}
